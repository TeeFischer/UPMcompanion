...
class LiveGraph:
    ...
    def update4(self, data):
        ...
        # Plotte zwei Linien für die beiden Datensätze
        # data[0] repräsentiert plot_data_t1 und data[3] repräsentiert plot_data_pwm
        self.ax.plot(data[0], label="T1 Data")  # Erste Linie (z.B. Temperatur)
        self.ax.plot(data[1], label="T2 Data")
        self.ax.plot(data[2], label="T3 Data")
        self.ax.plot(data[3], label="PWM Data")  # Zweite Linie (z.B. PWM Werte)
